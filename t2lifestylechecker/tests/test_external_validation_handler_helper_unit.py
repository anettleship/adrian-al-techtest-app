...
def test_get_localised_message_should_get_localised_message_for_language_code(
...
input_strings = [(str(111222333)), (str(444555666)), ("Cheese")]


@pytest.mark.parametrize("input", input_strings)
def test_obfuscate_string_base64_and_decode_string_base64_should_encode_and_decode_a_string_to_produce_the_same_output_as_input(
    input,
):
